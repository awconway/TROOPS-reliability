...
A data collection form that contained three parts was developed to be used in this study. The first part contained items to collect demographic (age, sex) and clinical information (type of procedure, procedure start and end time, baseline oxygen supplementation and total doses of sedation used) about the included patients.
